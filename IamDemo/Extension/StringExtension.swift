...
extension String {
    ...
    func height(withConstrainedWidth width: CGFloat, font: UIFont, lineBreakMode: NSLineBreakMode) -> CGFloat {
        ...
        let boundingBox = self.boundingRect(with: constraintRect, options: .usesLineFragmentOrigin, attributes: [NSAttributedString.Key.font: font, NSAttributedString.Key.paragraphStyle: paragraph], context: nil)
